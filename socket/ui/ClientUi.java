...
public class ClientUi extends JFrame {
	        ...
	        if (!str.equals("xxx")) {
	        	...
	        	if (op.equals("push")) {
                	...
                	while ((templine = buf.readLine()) != null) {
                		if(templine.equals("#@#@Over@#@#")) {					//读到文件末尾标志符，即停止
                			break;
                		}
	...
	public ClientUi() {
		...
		helpMenu.setFont(new Font("宋体", Font.PLAIN, 16));
		helpMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "帮助文档\n"
						...
						+ "目的地址中的文件夹名，例：copy E:\\test2\\1.txt E:\\test2\\123\n"
		...
		aboutMenu.setFont(new Font("宋体", Font.PLAIN, 16));
		menu.add(aboutMenu);
		...
		pushButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				opText.setText("push");
				srcpathlabel.setText("需上传的文件名的路径：");
		...
		pullButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				opText.setText("pull");
				srcpathlabel.setText("需下载的文件的路径：");
